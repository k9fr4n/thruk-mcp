...
def test_registry_tool_count() -> None:
    """Registry must contain exactly 51 tools (sentinel for accidental removals).
    ...
    Count history:
      ...
      = 51
    """
    assert len(TOOL_REGISTRY) == 51, (
        f"Expected 51 tools in TOOL_REGISTRY, got {len(TOOL_REGISTRY)}. "
